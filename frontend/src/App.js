...
// import { Upload, Send, File, Trash2, MessageCircle, Bot, User, Loader, CheckCircle, XCircle, Clock, FileText, AlertCircle } from 'lucide-react';
//
// const RagChatApp = () => {
...
//               RAG Document Chat
//             </h1>
//             <p className="text-slate-300">Chat with your documents using Mistral 7B</p>
//           </div>
//
//           <div className="flex gap-6 h-[calc(100vh-12rem)]">
//             {/* Sidebar */}
//             <div className="w-80 bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 overflow-hidden">
...
//
//             {/* Main Chat Area */}
//             <div className="flex-1 bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 flex flex-col overflow-hidden">
//               {/* Chat Messages */}
//               <div className="flex-1 overflow-y-auto p-6 space-y-6">
//                 {messages.length === 0 ? (
//                     <div className="text-center text-slate-400 mt-20">
//                       <Bot className="w-16 h-16 mx-auto mb-4 text-slate-500" />
//                       <p className="text-lg mb-2">Welcome to RAG Document Chat</p>
...
//                         className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
//                         disabled={isLoading}
//                     />
//                   </div>
//                   <button
...
//                       className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:from-slate-600 disabled:to-slate-600 text-white rounded-xl transition-all disabled:cursor-not-allowed flex items-center space-x-2"
//                   >
//                     {isLoading ? (
